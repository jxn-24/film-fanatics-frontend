      ...
      <div className="profile-container max-w-6xl mx-auto px-4 py-8">
        <div className="profile-header">
          <div className="flex items-start space-x-6">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold mb-2">Sophia Bennett</h1>
              <div className="flex items-center space-x-4 text-gray-600 mb-4">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span>89 movies watched</span>
                </div>
              </div>
              <p className="text-gray-700 mb-4">
                Film enthusiast with a passion for indie cinema and classic films. 
                Always looking for hidden gems and thought-provoking stories as of 12:27 AM EAT on Friday, July 18, 2025.
              </p>
            </div>
